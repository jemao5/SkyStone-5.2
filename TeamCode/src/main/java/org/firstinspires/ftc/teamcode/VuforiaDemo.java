...
public class VuforiaDemo extends LinearOpMode
{
    ...
    private static final String VUFORIA_KEY = ""; // Insert your own key here
    ...
    private void setupVuforia()
    {
        ...
        visionTargets = vuforiaLocalizer.loadTrackablesFromAsset("StoneAndChips");

        Vuforia.setHint(HINT.HINT_MAX_SIMULTANEOUS_IMAGE_TARGETS, 2);

        // Setup the target to be tracked
        target = visionTargets.get(1); // 0 corresponds to the wheels target
        target.setName("BlueTarget"); //Chips
